...
export const mockRecipes = [
  ...
  },
  {
    ...
    servings: 1,
    totalCost: 4200,
    tip: '닭가슴살은 껍질이 붙어있는 것으로 준비하세요! 자세한 조리 방법은 위 영상을 참고해주세요. 다른 버전이 궁금하다면 이 영상도 참고: https://www.youtube.com/watch?v=s3Dt9q5epz0&t=2003s',
    ingredients: [
      { name: '닭가슴살', amount: '150g, 껍질 포함' },
      { name: '소금', amount: '약간' },
      { name: '백후추', amount: '약간' },
    ...
    steps: [
      '닭가슴살에 소금과 백후추로 밑간한다.',
      '팬에 올리브오일을 두르고 껍질 쪽부터 올려 굽는다.',
      '윗면 가장자리 색이 익은 것처럼 변하면 뒤집는다.',
      '버터와 허브(타임&바질)를 넣고 녹인 버터를 끼얹어가며 마저 굽는다.',
      '다 익으면 잠시 그대로 두었다가(레스팅) 썰어서 낸다.',
    ],
  },
  {
