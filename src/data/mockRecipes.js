...
export const mockRecipes = [
  {
    ...
    image: '/recipes/gyeran-bokkeumbap.png',
  ...
  },
  {
    ...
    image: '/recipes/kimchi-bokkeumbap.png',
    categoryId: 'bokkeumbap',
    servings: 1,
    totalCost: 2800,
    ingredients: [
  ...
  },
  {
    ...
    image: '/recipes/saeu-bokkeumbap.png',
    categoryId: 'bokkeumbap',
    servings: 1,
    totalCost: 3400,
    ingredients: [
  ...
  },
  {
    ...
    name: '부대찌개',
    emoji: '🍲',
    youtubeId: '7awcUIb0g7w',
    image: youtubeThumbnail('7awcUIb0g7w'),
    categoryId: 'jjigae',
    servings: 1,
    totalCost: 4000,
    ingredients: [
  ...
  },
  {
    ...
    name: '소고기덮밥',
    emoji: '🐄',
    youtubeId: 'efeLmSF2-J8',
    image: youtubeThumbnail('efeLmSF2-J8'),
    categoryId: 'deopbap',
    servings: 1,
    totalCost: 4800,
    ingredients: [
  ...
  {
    id: 'samgyeopsal-gochujang-bokkeumbap',
    name: '고추장 삼겹 볶음밥',
    emoji: '🐷',
    youtubeId: 'u0WxnDtgY18',
    image: youtubeThumbnail('u0WxnDtgY18'),
    categoryId: 'bokkeumbap',
    servings: 1,
    totalCost: 3200,
    ingredients: [
  ...
  {
    id: 'dajim-sogogi-bokkeumbap',
    name: '다짐육 소고기볶음밥',
    emoji: '🍚',
    youtubeId: '8Kc-E3lHpTY',
    image: youtubeThumbnail('8Kc-E3lHpTY'),
    categoryId: 'bokkeumbap',
    servings: 1,
    totalCost: 3200,
    ingredients: [
      { name: '다짐소고기', amount: '100g' },
      { name: '밥', amount: '1공기' },
      { name: '당근', amount: '약간' },
      { name: '대파', amount: '1/4대' },
    ],
  ...
  },
  {
    ...
    name: '다시마채무침',
    emoji: '🍀',
    youtubeId: '-Gjl22BVMnE',
    image: youtubeThumbnail('-Gjl22BVMnE'),
    categoryId: 'muchim',
    servings: 1,
    totalCost: 1800,
    ingredients: [
      { name: '다시마', amount: '100g' },
      { name: '마늘', amount: '약간' },
      { name: '고춧가루', amount: '1작은술' },
      { name: '식초', amount: '1큰술' },
      { name: '설탕', amount: '약간' },
