...
export const fridgeIngredients = [
  ...
  { id: 'tofu-regular', label: '두부', emoji: '🧈', matchNames: ['두부'], group: '두부' },
  { id: 'tofu-soft', label: '순두부', emoji: '🥣', matchNames: ['순두부'], group: '두부' },
  { id: 'pork-neck', label: '목살', emoji: '🐷', matchNames: ['목살'], group: '돼지고기' },
  { id: 'pork-belly', label: '삼겹살', emoji: '🥓', matchNames: ['삼겹살'], group: '돼지고기' },
  { id: 'beef-bulgogi', label: '불고기용소고기', emoji: '🥩', matchNames: ['불고기용소고기'], group: '소고기' },
  { id: 'beef-ground', label: '다짐소고기', emoji: '🍖', matchNames: ['다짐소고기'], group: '소고기' },
  ...
  { id: 'udon', label: '우동면', emoji: '🍜', matchNames: ['우동면'] },
  { id: 'glass-noodle', label: '당면', emoji: '🥢', matchNames: ['당면'] },
]
