...
지난 회의에서 이미 정한 기능 범위의 이유를 다시 묻느라 팀이 같은 설명을 반복했다. 결론만 남기고 판단 근거를 원문과 연결하지 않은 것이 원인이었다.
...
메신저 자동 연동과 실시간 녹음은 초기 구현 범위를 크게 늘리기 때문에, 팀은 MVP에서 두 기능을 제외하고 사용자가 직접 붙여 넣은 기록을 분석하기로 결정했다. 다음 회의까지 입력 화면, 분석 결과, 신규 팀원 온보딩 요약을 준비하기로 했다.
...
export const sampleAnalysis: ContextAnalysisResult = {
  ...
  summary: {
    projectTitle: "캠퍼스 공모전 서비스 기획",
    overview: [
      "결론만 남아 결정 이유를 다시 설명해야 하는 팀의 반복을 줄인다.",
  ...
  decisions: [
    {
      ...
      status: "confirmed",
      evidence: evidence("메신저 자동 연동과 실시간 녹음은 초기 구현 범위를 크게 늘리기 때문에, 팀은 MVP에서 두 기능을 제외하고 사용자가 직접 붙여 넣은 기록을 분석하기로 결정했다."),
    },
    {
