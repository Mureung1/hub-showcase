    ...
    <main className="onboarding-page" aria-labelledby="onboarding-title">
      ...
      >
        ...
        <div className="problem-grid">
          <article>
            <span>01</span>
            <h3>어디에 저장했는지 잊어요</h3>
            <p>북마크, 메신저, 메모 앱에 흩어진 자료가 다시 찾기를 어렵게 합니다.</p>
          </article>
          <article>
            <span>02</span>
            <h3>검색어가 기억나지 않아요</h3>
            <p>필요한 건 떠오르지만, 저장 당시의 제목이나 키워드는 자주 사라집니다.</p>
          </article>
          <article>
            <span>03</span>
            <h3>쓸 순간과 저장 순간이 달라요</h3>
            <p>저장할 때의 분류보다, 나중에 하려는 일이 더 중요한 단서가 됩니다.</p>
          </article>
        </div>
      </section>
      ...
      >
        ...
        <div className="benefit-grid">
          ...
          <article>
            <h3>정리 부담 감소</h3>
            <p>처음부터 완벽히 분류하지 않아도 저장과 재활용 흐름이 이어집니다.</p>
          </article>
          <article>
            <h3>작업으로 연결</h3>
            <p>과제, 팀 프로젝트, 공부, 포트폴리오 자료를 다시 실제 작업에 씁니다.</p>
          </article>
        </div>
      </section>

      <section className="onboarding-final-cta" aria-labelledby="onboarding-final-title">
