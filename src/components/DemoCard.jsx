...
// 정상 → 주의 → 임박 → 만료로 배지 색이 바뀌는 모습을 보여준다.
const STEP_MS = 2200;
...
export default function DemoCard() {
  ...
  return (
    <div
      className="demo"
      role="img"
      aria-label="스캔 재고 데모: 상품별 재고 수량과 유통기한 상태(정상·주의·임박·만료)를 보여주는 카드"
    >
      <div className="demo-top">
        <span className="demo-title">
          <span aria-hidden="true">📷</span> 스캔 재고
        </span>
