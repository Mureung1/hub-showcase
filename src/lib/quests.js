...
export const WEEKLY_QUEST_POOL = [
  { id: 'week-log-3', title: '이번 주 3일 이상 기록', description: '이번 주 3일 이상 식사를 기록해보세요.', xp: 50, category: 'log', evaluate: (ctx) => (ctx.weekLoggedDays ?? 0) >= 3 },
  { id: 'week-log-4', title: '이번 주 4일 이상 기록', description: '이번 주 4일 이상 식사를 기록해보세요.', xp: 75, category: 'log', evaluate: (ctx) => (ctx.weekLoggedDays ?? 0) >= 4 },
  { id: 'week-log-5', title: '이번 주 5일 이상 기록', description: '이번 주 5일 이상 식사를 기록해보세요.', xp: 100, category: 'log', evaluate: (ctx) => (ctx.weekLoggedDays ?? 0) >= 5 },
  { id: 'week-log-6', title: '이번 주 6일 이상 기록', description: '이번 주 6일 이상 식사를 기록해보세요.', xp: 125, category: 'log', evaluate: (ctx) => (ctx.weekLoggedDays ?? 0) >= 6 },
  { id: 'week-log-7', title: '이번 주 개근 기록', description: '이번 주 7일 모두 식사를 기록해보세요.', xp: 150, category: 'log', evaluate: (ctx) => (ctx.weekLoggedDays ?? 0) >= 7 },
  { id: 'week-3meals-2', title: '세 끼 모두 채운 날 2일', description: '이번 주 세 끼를 모두 채운 날이 2일 이상 되어보세요.', xp: 50, category: 'meal-completeness', evaluate: (ctx) => (ctx.weekThreeMealDays ?? 0) >= 2 },
  { id: 'week-3meals-3', title: '세 끼 모두 채운 날 3일', description: '이번 주 세 끼를 모두 채운 날이 3일 이상 되어보세요.', xp: 75, category: 'meal-completeness', evaluate: (ctx) => (ctx.weekThreeMealDays ?? 0) >= 3 },
  { id: 'week-3meals-4', title: '세 끼 모두 채운 날 4일', description: '이번 주 세 끼를 모두 채운 날이 4일 이상 되어보세요.', xp: 100, category: 'meal-completeness', evaluate: (ctx) => (ctx.weekThreeMealDays ?? 0) >= 4 },
  { id: 'week-water-3', title: '이번 주 물 목표 3일 달성', description: '이번 주 물 목표(80% 이상)를 3일 이상 달성해보세요.', xp: 50, category: 'water', evaluate: (ctx) => (ctx.weekWaterMetDays ?? 0) >= 3 },
  { id: 'week-water-4', title: '이번 주 물 목표 4일 달성', description: '이번 주 물 목표(80% 이상)를 4일 이상 달성해보세요.', xp: 75, category: 'water', evaluate: (ctx) => (ctx.weekWaterMetDays ?? 0) >= 4 },
  { id: 'week-water-5', title: '이번 주 물 목표 5일 달성', description: '이번 주 물 목표(80% 이상)를 5일 이상 달성해보세요.', xp: 100, category: 'water', evaluate: (ctx) => (ctx.weekWaterMetDays ?? 0) >= 5 },
  { id: 'week-supplement-3', title: '영양제 3일 챙기기', description: '이번 주 영양제를 3일 이상 챙겨보세요.', xp: 25, category: 'supplement', evaluate: (ctx) => (ctx.weekSupplementDays ?? 0) >= 3 },
  { id: 'week-supplement-5', title: '영양제 5일 챙기기', description: '이번 주 영양제를 5일 이상 챙겨보세요.', xp: 75, category: 'supplement', evaluate: (ctx) => (ctx.weekSupplementDays ?? 0) >= 5 },
  { id: 'week-supplement-7', title: '영양제 개근', description: '이번 주 7일 모두 영양제를 챙겨보세요.', xp: 125, category: 'supplement', evaluate: (ctx) => (ctx.weekSupplementDays ?? 0) >= 7 },
  { id: 'week-sodium-3', title: '나트륨 관리 3일', description: '이번 주 나트륨 관리를 3일 이상 성공해보세요.', xp: 50, category: 'sodium', evaluate: (ctx) => (ctx.weekSodiumOkDays ?? 0) >= 3 },
  { id: 'week-sodium-4', title: '나트륨 관리 4일', description: '이번 주 나트륨 관리를 4일 이상 성공해보세요.', xp: 75, category: 'sodium', evaluate: (ctx) => (ctx.weekSodiumOkDays ?? 0) >= 4 },
  { id: 'week-sodium-5', title: '나트륨 관리 5일', description: '이번 주 나트륨 관리를 5일 이상 성공해보세요.', xp: 100, category: 'sodium', evaluate: (ctx) => (ctx.weekSodiumOkDays ?? 0) >= 5 },
  { id: 'week-streak-5', title: '이번 주 5일 연속 기록', description: '이번 주 안에서 5일 연속으로 기록해보세요.', xp: 100, category: 'streak', evaluate: (ctx) => (ctx.weekLongestStreak ?? 0) >= 5 },
  { id: 'week-quiz-3', title: '이번 주 퀴즈 3회 정답', description: '이번 주 식단 퀴즈를 3회 이상 맞혀보세요.', xp: 75, category: 'quiz', evaluate: (ctx) => (ctx.weekQuizDays ?? 0) >= 3 },
  { id: 'week-quiz-5', title: '이번 주 퀴즈 5회 정답', description: '이번 주 식단 퀴즈를 5회 이상 맞혀보세요.', xp: 125, category: 'quiz', evaluate: (ctx) => (ctx.weekQuizDays ?? 0) >= 5 },
  // ── 다양성 확대(주간 노출 개수 3→5에 맞춰 추가) — 물/나트륨/영양제에 편중되지 않도록 daily
  // 풀에만 있던 단백질/탄수화물/지방/식이섬유/칼로리 판정과 "새 기능 사용" 유도, 다양한 음식 섭취를
  // 주간 버전으로도 넣는다.
  { id: 'week-protein-3', title: '단백질 80% 3일 달성', description: '이번 주 단백질 섭취를 80% 이상 채운 날이 3일 이상 되어보세요.', xp: 50, category: 'protein', evaluate: (ctx) => (ctx.weekProteinOkDays ?? 0) >= 3 },
  { id: 'week-protein-5', title: '단백질 80% 5일 달성', description: '이번 주 단백질 섭취를 80% 이상 채운 날이 5일 이상 되어보세요.', xp: 100, category: 'protein', evaluate: (ctx) => (ctx.weekProteinOkDays ?? 0) >= 5 },
  { id: 'week-carbs-3', title: '탄수화물 80% 3일 달성', description: '이번 주 탄수화물 섭취를 80% 이상 채운 날이 3일 이상 되어보세요.', xp: 50, category: 'carbs', evaluate: (ctx) => (ctx.weekCarbsOkDays ?? 0) >= 3 },
  { id: 'week-fat-3', title: '지방 적정 범위 3일 달성', description: '이번 주 지방 섭취를 적정 범위로 맞춘 날이 3일 이상 되어보세요.', xp: 50, category: 'fat', evaluate: (ctx) => (ctx.weekFatOkDays ?? 0) >= 3 },
  { id: 'week-fiber-3', title: '식이섬유 80% 3일 달성', description: '이번 주 식이섬유 섭취를 80% 이상 채운 날이 3일 이상 되어보세요.', xp: 50, category: 'fiber', evaluate: (ctx) => (ctx.weekFiberOkDays ?? 0) >= 3 },
  { id: 'week-calorie-3', title: '칼로리 적정 범위 3일 달성', description: '이번 주 칼로리 섭취를 적정 범위로 맞춘 날이 3일 이상 되어보세요.', xp: 75, category: 'calorie', evaluate: (ctx) => (ctx.weekCalorieOkDays ?? 0) >= 3 },
  { id: 'week-calorie-5', title: '칼로리 적정 범위 5일 달성', description: '이번 주 칼로리 섭취를 적정 범위로 맞춘 날이 5일 이상 되어보세요.', xp: 125, category: 'calorie', evaluate: (ctx) => (ctx.weekCalorieOkDays ?? 0) >= 5 },
  { id: 'week-variety-5', title: '이번 주 5가지 다른 음식 먹기', description: '이번 주 서로 다른 음식을 5가지 이상 기록해보세요.', xp: 50, category: 'variety', evaluate: (ctx) => (ctx.weekUniqueFoodCount ?? 0) >= 5 },
  { id: 'week-variety-8', title: '이번 주 8가지 다른 음식 먹기', description: '이번 주 서로 다른 음식을 8가지 이상 기록해보세요.', xp: 100, category: 'variety', evaluate: (ctx) => (ctx.weekUniqueFoodCount ?? 0) >= 8 },
  { id: 'week-try-combo', title: '커스텀 조합 빌더 사용해보기', description: '홈 화면의 커스텀 조합 빌더로 나만의 조합을 만들어보세요.', xp: 25, category: 'feature', evaluate: (ctx) => (ctx.weekComboBuilderDays ?? 0) >= 1 },
  { id: 'week-try-mapduel', title: '지도 듀얼 비교 사용해보기', description: '지도에서 식당 두 곳을 골라 영양을 비교해보세요.', xp: 25, category: 'feature', evaluate: (ctx) => (ctx.weekMapDuelDays ?? 0) >= 1 },
  // ── 다양화(리텐션 강화 v5) — 아침/저녁 챙기기, 짧은 주간 스트릭, 퀴즈 1회, 기능 2종 모두 써보기 등
  // 새 카테고리를 추가해 "물 목표 3/4/5일"류의 같은 행동 반복 노출을 줄인다.
  { id: 'week-breakfast-3', title: '아침 챙기기 3일', description: '이번 주 아침을 챙긴 날이 3일 이상 되어보세요.', xp: 50, category: 'breakfast', evaluate: (ctx) => (ctx.weekBreakfastDays ?? 0) >= 3 },
  { id: 'week-dinner-3', title: '저녁 챙기기 3일', description: '이번 주 저녁을 챙긴 날이 3일 이상 되어보세요.', xp: 50, category: 'dinner', evaluate: (ctx) => (ctx.weekDinnerDays ?? 0) >= 3 },
  { id: 'week-streak-3', title: '이번 주 3일 연속 기록', description: '이번 주 안에서 3일 연속으로 기록해보세요.', xp: 75, category: 'streak', evaluate: (ctx) => (ctx.weekLongestStreak ?? 0) >= 3 },
  { id: 'week-quiz-1', title: '이번 주 퀴즈 1회 정답', description: '이번 주 식단 퀴즈를 1회 이상 맞혀보세요.', xp: 50, category: 'quiz', evaluate: (ctx) => (ctx.weekQuizDays ?? 0) >= 1 },
  {
    id: 'week-try-both',
