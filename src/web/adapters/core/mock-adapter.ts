...
export class MockAdapter implements CoreAdapter {
  ...
  async joinOfficialChallenge(_ctx: Parameters<CoreAdapter['joinOfficialChallenge']>[0], input: Parameters<CoreAdapter['joinOfficialChallenge']>[1]) { return adapterOk({ participationId: `participation-${input.challengeId}`, balanceAfter: 750 }); }
