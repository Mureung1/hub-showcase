...
- **혜택은 반드시 금액 할인으로만 쓰세요.** promo.value는 "N원 할인" 형태여야 하고,
  copy에도 같은 금액을 그대로 적으세요. 1,000원·2,000원처럼 딱 떨어지는 금액이 좋습니다.
- **금액은 3,000원을 넘지 마세요.**
- **퍼센트(%) 할인 금지.** "10% 할인", "반값" 모두 안 됩니다.
- **무료 증정·1+1 금지.** "스콘 1개 무료", "1+1", "○○ 증정" 모두 안 됩니다.
  공짜로 주는 대신 그만큼 금액을 깎아주는 문구로 바꿔 쓰세요.
- channels는 instagram, x, dangol 중에서 고르세요.

[좋은 예시] (비 오는 날)
title: 비 오는 날 픽업 1,000원 할인
copy: ☔ 비 오는 오늘, 나가기 귀찮으시죠?
따뜻한 아메리카노 미리 주문하고 픽업만 쏙 해가세요 ☕
오늘 픽업 주문 1,000원 할인이에요 🎉

[나쁜 예시] — promo.value에 이렇게 쓰면 안 됩니다
"픽업 10% 할인"  ← 퍼센트라서 안 됨
"스콘 1개 무료"  ← 무료 증정이라 안 됨
"1+1 이벤트"     ← 증정이라 안 됨

반드시 아래 JSON 형식으로만 응답하세요(다른 텍스트 없이):
{"title": "캠페인 제목", "copy": "발송 문구", "promo": {"type": "할인", "value": "픽업 1,000원 할인"}, "channels": ["dangol", "instagram"]}`;
}
