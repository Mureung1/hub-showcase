...
4. **단위 테스트**:
   - `npm run verify:risk --workspace showup` (위험도 계산 8개 케이스)
   - `npm run verify:phone --workspace showup` (전화번호 파싱/마스킹 8개 케이스)
...
`~/.hermes/skills/software-development/showup-verify/SKILL.md`에서 확인 가능합니다.