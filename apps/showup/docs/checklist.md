...
### 🟦 프론트엔드
- [x] 고객 등록 폼 (이름/전화 검증, 중복 시 기존 고객 안내 모달)
- [x] 고객 목록 (카드형, 전화 마스킹 `010-****-1234`)
- [x] 검색 바: phoneLast4/이름, debounce 300ms

### 🟩 백엔드
- [x] 고객 CRUD 서비스 함수 — phoneLast4 자동 생성 포함 (Firestore 연동)
- [x] 고객 목록 쿼리: storeId + phoneLast4 / name 검색

### 🟥 보안
- [x] 고객 컬렉션 규칙: 본인 가게만 read/write 확인
- [x] 전화번호 원본 노출 경로 전수 확인 (마스킹 누락 0건)

### 🟨 리드
- [x] 고객 스키마 ↔ FE/BE 인터페이스 일치 확인
- [x] 4일차 진행 체크
