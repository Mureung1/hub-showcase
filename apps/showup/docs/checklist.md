...
### 백엔드
- [ ] 통합 QA 버그 수정 (BE 담당분) — 미완료
- [ ] 데모용 가게 계정 생성 — 미완료
- [ ] 프로덕션 시드/데모 데이터 확정 — 미완료
- [ ] Cloud Functions 프로덕션 배포 — **Spark 요금제 불가, 클라이언트 갱신으로 대체 (riskRefresh.ts 복구)**
- [ ] Firestore 프로덕션 인덱스 배포 — 미완료
