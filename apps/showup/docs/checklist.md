...
### 리드
- [✅] 버그 재점검 — bug-list.md P2 잔여 항목과 핵심 시나리오 재확인; Lighthouse 실측은 도구 미설치로 보류
...
- [ ] Lighthouse 실측 (P2 잔여) — Lighthouse CLI 미설치, 설치 후 측정 필요

### 백엔드
- [ ] 데모 계정 + 시드 데이터 프로덕션 재확인
- [ ] 버그 재점검 — BE 담당분 잔여 없는지 확인

### 보안
- [ ] 프로덕션 최종 스모크 테스트 재실행 (14개 PASS 재확인)
