...
| SemesterWorkspace | `/api/product/bootstrap`으로 active workspace·Course·material registry를 hydrate하고 loading, inactive, no Course, empty, incompatible와 Server failure를 학생용 copy로 구분한다. |
