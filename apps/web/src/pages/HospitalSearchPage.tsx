import { Clock3, LogIn, MapPin, Search, Stethoscope } from "lucide-react";
  ...
  return (
    <div className="app-shell">
      <header className="topbar">
        <a className="brand" href="/" aria-label="바로진료 홈">
          ...
          <div className="hospital-list">
            {filteredHospitals.map((hospital) => (
              <article className="hospital-card" key={hospital.id}>
                ...
                <button className="detail-button" type="button" disabled={!hospital.remoteOpen}>
