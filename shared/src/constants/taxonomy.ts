...
// 원문 → Canonical 매핑 테이블
export const MAJOR_MAPPING = taxonomyData.major_mapping as Record<string, CanonicalMajor[]>;
export const REGION_MAPPING = taxonomyData.region_mapping as Record<string, CanonicalRegion[]>;
...
export const GRADE_TYPES = [1, 2, 3, 4] as const;
