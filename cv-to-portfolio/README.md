...
flowchart LR
  ...
  subgraph S["API · Express(로컬·Vercel) / Sites Worker"]
...
사용하는 Express(로컬·Vercel) 또는 Sites Worker에 생성을 요청합니다. 서버만 보관하는 API 키로
...
- 🚀 [Vercel 공개 배포](https://cv2pf-jd-portfolio.vercel.app) · [5분 데모 영상](https://drive.google.com/drive/folders/16-eF-KIwCGqVP6CNIYkyBcJ_vK95ei9E?usp=sharing) · [배포·검증·Agent 작업 기록](docs/deployment-and-video-submission-2026-07-30.md)
