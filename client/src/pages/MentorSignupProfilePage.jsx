...
function MentorSignupProfilePage() {
  ...
  // 계정 정보 없이(직접 URL 접근, 새로고침 등) 들어온 경우 1단계로 되돌린다.
  useEffect(() => {
    if (hasAccountInfo) return;
    navigate(routePaths.mentorSignup, { replace: true });
  }, [hasAccountInfo, navigate]);
    ...
    <div className="mentor-signup-page">
      ...
      <main className="page-container mentor-signup-container">
        <section className="mentor-signup-heading" aria-labelledby="mentor-signup-title">
          ...
          <p className="body-text">멘티에게 보여줄 프로필 정보를 입력하면 가입이 완료됩니다.</p>
        </section>
          ...
          <section className="card mentor-signup-section mentor-signup-section-accent" aria-labelledby="mentor-profile-title">
            <div className="mentor-section-heading">
              ...
              <p className="muted-text">
                멘티가 멘토를 선택할 때 확인하는 정보입니다. <span aria-hidden="true">*</span> 표시는 필수 입력 항목입니다.
              </p>
            </div>
...
export default MentorSignupProfilePage;
