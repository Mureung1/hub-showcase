  ...
  return (
    <div className="feed-column" style={{
      ...
      <div style={{ flex: 1 }}>
        ...
        <h1 style={{ fontSize: '28px', fontWeight: 'bold', marginBottom: '24px', color: 'var(--color-text-primary)' }}>
          {post.title}
        </h1>
        ...
        <div style={{ display: 'flex', alignItems: 'center', marginBottom: '32px', paddingBottom: '24px', borderBottom: '1px solid var(--color-divider)' }}>
          ...
          <div>
            ...
            <div style={{ fontSize: '14px', color: 'var(--color-text-secondary)', marginTop: '4px' }}>
              {(post.grade_tag || post.author_grade || '1학년')} • {post.created_at ? new Date(post.created_at).toLocaleString() : '방금 전'}
            </div>
          </div>
        </div>
