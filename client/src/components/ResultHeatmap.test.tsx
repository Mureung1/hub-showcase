...
const respondedResult: SlotResult = { date: '2026-07-20', time: '09:00', availableCount: 3, preferredCount: 1 }
...
describe('ResultHeatmap', () => {
  it('응답 있는 칸을 클릭하면 모달에 정확한 가능/선호 인원수가 뜬다(선호 인원은 가능에 중복 집계하지 않음)', () => {
