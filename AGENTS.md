...
Keep branch names and camp labels separate. Daily branches stay date-based as `codex/MMDD`; camp-provided labels such as `[1-3] 기획완성`, `[1-3] 프로토타이핑`, or `[1-4] design-system` capture the week/day mission category on PRs.
