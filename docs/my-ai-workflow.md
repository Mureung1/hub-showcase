...
> **이 문서는 3주차 시점의 기록이다. 최종본은 [my-workflow.md](my-workflow.md) 를 본다.**
> 아래 내용 중 두 가지가 실제와 달랐고, 최종본 6장에서 바로잡았다.
> `design-skill.md` 는 Skill 이 아니라 저장소 루트의 참고 문서이고,
> "다음에 이어갈 것"의 과목 완료 체크는 4주차에 구현했다.
