...
.btn-primary {
  ...
  background: var(--gradient-primary);    /* 파란 계열 은은한 세로 그라데이션 */
...
.btn-primary:active { background: var(--gradient-primary-pressed); }
