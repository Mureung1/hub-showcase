...
| App-owned SemesterWorkspace ADR | [adr/0014-create-app-owned-normalized-semester-workspaces.md](adr/0014-create-app-owned-normalized-semester-workspaces.md) | ADR 0018이 대체한 normalized scaffold·복사 기반 `ImportSource` 결정 |
