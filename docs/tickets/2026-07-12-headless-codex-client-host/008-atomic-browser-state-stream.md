...
이 ticket의 Host snapshot/SSE 제품 계약은 [ADR 0010](../../adr/0010-separate-codex-app-server-connection-from-conversation-runtime.md)의 runtime foundation 범위가 아니다. Browser 제공은 foundation conformance를 통과한 뒤 별도 제품 goal에서 결정하며 아래 인수 조건은 당시 계획 근거로만 남긴다.
