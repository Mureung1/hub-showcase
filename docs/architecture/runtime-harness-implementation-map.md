...
| `npm run validate --prefix vendor/ai-sdk-provider-codex-cli` | 격리 fork의 exact Codex pin/generated snapshot, generated sole-ingress decoder, adopted outbound builder와 method-specific response decoder, donor build·typecheck·format·lint와 non-live regression. Raw-byte/RequestId·transport hardening과 live conformance는 아직 증명하지 않는다. |
