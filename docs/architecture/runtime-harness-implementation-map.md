...
| `npm run validate --prefix vendor/ai-sdk-provider-codex-cli` | 격리 fork의 exact Codex pin/generated snapshot, generated sole-ingress decoder, adopted outbound builder·method-specific response decoder, lifecycle identity view, package-private turn-event router와 native turn-result collector, donor build·typecheck·format·lint와 non-live regression. Bounded staging, raw-byte/RequestId·transport hardening과 live conformance는 아직 증명하지 않는다. |
