...
| Public npx Runtime delivery | 중단한 release lane의 `@ay-ple/runtime-release`와 `apps/ay-ple` production host는 tracked graph에서 제거했다. 당시 결정과 구현 증거만 historical artifact에 남는다. | [historical ADR 0016](../adr/0016-distribute-public-preview-with-an-exact-npx-launcher-and-verified-runtime-release.md) |
