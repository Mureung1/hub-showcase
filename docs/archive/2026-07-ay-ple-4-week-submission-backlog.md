...
| W1-05 | Runtime Diagnostic History에 100ms checkpoint, interrupted-run recovery, count/byte retention과 terminal clear를 구현했다. | [Runtime Harness Hardening PRD](../specs/2026-07-10-runtime-harness-hardening.md) |
| W1-06 | Runtime persistence 실패를 fail-closed로 처리하고 degraded HTTP/UI와 함께 local issues 001–005를 구현·검증했다. | [Runtime hardening issues](../tickets/2026-07-10-runtime-harness-hardening/) |
