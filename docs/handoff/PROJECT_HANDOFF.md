...
> **⚠️ 아카이브됨 (2026-07-30).** 이 문서는 2026-07-14 이후 갱신되지 않아 이후 결정(Gemini 연동, 결과 재정의 ADR-009, 데모 영상 등)을 반영하지 못한다. **최신 상태는 [`CODEX_HANDOFF_2026-07-29.md`](./CODEX_HANDOFF_2026-07-29.md)(가장 최근 일일 인수인계)와 [`../final-summary.md`](../final-summary.md)(프로젝트 의미·4주 회고)를 참고할 것.** 아래 내용은 2026-07-14 시점 스냅샷으로 역사적 참고용으로만 남긴다.
>
