...
환자용 화면과 병원 관리자용 화면은 분리하지만 로그인 계정은 공통 계정 구조를 사용합니다. MVP에서 병원 승인은 mock 또는 DB에서 수동 처리합니다.

## 사용자 시나리오

### 원격 환자

1. 환자가 아이디와 비밀번호로 회원가입하고 로그인합니다.
...
- 환자 회원가입·로그인과 계정당 활성 웨이팅 제한
- 가족 단위 원격 웨이팅과 실시간 상태 확인
- 병원의 원격·현장 통합 대기열 관리
