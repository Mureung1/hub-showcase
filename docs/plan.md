...
### 검증 후 MVP 편입 (2순위)
- **취업진로포털 (세션 기반)** — 홈 미리보기만 공개, 전체 프로그램 목록은 로그인 필요. 단, 포털 로그인의 "신뢰할 수 있는 기기등록"을 활용하면 최초 1회 수동 인증 후 세션 재사용 가능성 확인됨. 세션 만료 주기 검증 후 편입 여부 결정
...
| 취업진로포털 | "신뢰 기기등록" 후 세션 재사용 방식 검토 중 (세션 만료 주기 검증 필요, 본인 계정·개인 사용 범위 한정) |
