# Product Backlog: Scholar-Sync AI

| Task ID | Week | Layer | Vertical Slice Group | Task Name | Tech Keyword | Priority | Owner | Status |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| TSK-001 | Week 2 (July 13-17) | FE | VS-1: MVP Layout | Implement global header and 2x2 bento grid layout (30:10:60 visual ratio) | React, Pure CSS | P0 | Human | Todo |
| TSK-002 | Week 2 (July 13-17) | BE | VS-2: Query Pipeline | Create mockup Express endpoints for NLP query processing and handle CORS | Express, Node.js | P0 | Agent | Todo |
