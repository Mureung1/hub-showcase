...
- [ ] **RulesPage itself** — still a stub; needs to actually render the resolved `RegionRule` (steps/schedule per category) for the region saved via the HomePage sheet
