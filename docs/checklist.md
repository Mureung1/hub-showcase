...
- [ ] T5. `[P0]` 사용자 입력 → 공고 매칭/추천 로직 설계 (T3 선행) — 수요일 (T3가 화요일에 끝나서 하루 앞당김)
...
---
작성일: 2026-07-10 · 수정일: 2026-07-14 (화=T2-a+T4+T3 완료, 수 예정=T2-b+T5 · 공고 데이터는 Supabase가 아닌 postings.json으로 유지, Supabase는 사용자 프로필 저장 전용으로 스코프 명확화)