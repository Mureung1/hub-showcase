...
- [ ] T3. `[P0]` 목업 공고 데이터셋 설계·작성 (채용/인턴십/공모전/대외활동 4개 카테고리, 총 10건: 채용 4·인턴십 2·공모전 2·대외활동 2, 자소서 문항 포함) — `backend/data/postings.json` 파일로 관리, Supabase와 무관 (선행 작업 없음, T2-b와 독립적으로 진행 가능) — 수요일
