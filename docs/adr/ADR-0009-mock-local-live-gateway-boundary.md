...
OpenAI 등 제3자 LLM 전달을 차단한다. Local Live canary는 일시적인 인증·schema
...
증거로 남긴다. 로그·JUnit XML·artifact·Docker 설정에서 key나 원문 응답을 찾으면
