...
- App-managed custom MCP lifecycle, tool-call·request-scoped idempotency·unknown-outcome reconciliation과 MCP started·completed·result를 같은 Chat transcript에 투영하는 product integration gate
- [023](023-state-patch-review-interaction-donor.md)이 Plan mode·pending interaction에서 흡수할 UX·identity·resume semantics와 열린 Turn 대 durable 후속 Turn의 assumption delta
