...
- [x] **T17. 실행 환경·Vercel 세팅 + 목 1차 배포** — 의존: T14. Node 22.12.0 고정·로컬 전체 검증, Vercel Git 연동·Production Branch·비프로덕션 Preview 배포 확인. `79a9478`에서 `ci.yml` 재설치로 `verify` Actions run 복구. 공개 Production·Preview S0 실물 확인 완료(사용자 확인, 2026-07-21). 절차와 근거는 docs/CICD.md·T17 하네스
