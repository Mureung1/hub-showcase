...
| MAP-004 | 핵심 점포 방향 독립형 3D store marker와 업종 asset system | P1 | In Progress | Phase 2 | ARCH-002, SEARCH-001, WEB-003 | canonical 꽃집 `G21901` 검색 결과를 custom 3D layer에 연결하고 중복 marker·building 충돌을 제거했다. 지원 4개 업종 asset 확대와 GLB cache는 남았다 |
