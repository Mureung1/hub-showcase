...
- `.reader-layout`은 통계 분석·채용공고 해설·합격 전략·준비 로드맵의 본문·목차 레이아웃입니다. 본문 최대 폭은 `980px`, 오른쪽 목차 폭은 `220px`입니다.
...
- 채용공고 해설·합격 전략 화면에 추가되는 컴포넌트(항목 카드, 체크리스트 표)도 동일한 카드·표 규칙과 토큰을 따릅니다.
