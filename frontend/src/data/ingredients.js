...
const INGREDIENT_LIST = [
  ...
  { id: 'kimchi', emoji: '🫙', name: '김치', category: 'fresh', defaultUnitLabels: ['1통', '반통', '1/4통', '소진'], avgShelfLifeDays: { spring: 60, summer: 40, fall: 60, winter: 90 }, role: '볶음밥, 찌개, 전 등 한식 어디에나 들어가는 새콤한 발효 반찬이에요.', tip: '국물이 새지 않게 꾹꾹 눌러 담아 밀폐하고, 새로 산 김치는 아래에 두어 오래된 것부터 드세요.' },
