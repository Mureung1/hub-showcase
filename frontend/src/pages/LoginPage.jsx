...
const LoginPage = () => {
  ...
  return (
    <main id="login-page" className="relative isolate min-h-[100dvh] overflow-hidden bg-[#17241f]">
      <div
        className="
      ...
      >
        ...
        <button
          className="
            ...
            before:pointer-events-none before:absolute before:inset-[5px]
      ...
      <section
        ...
        <p className="hidden max-w-[27rem] text-[clamp(0.98rem,1.25vw,1.12rem)] leading-[1.75] text-[#e4e2d8] md:mt-6 md:block">
