    ...
    <section>
      ...
      <div className="rs-guide-body">
        <div className="rs-panel">
          <h2>역기획서란?</h2>
          <p>
            이미 서비스 중인 게임의 시스템을 "내가 이 게임의 기획자라면 이 명세서를 어떻게
            썼을까"의 관점으로 거꾸로 복원하는 문서입니다. 게임 기획 입문 훈련이자 지망생
            포트폴리오의 표준 형식으로 쓰입니다. 핵심은 요약이 아니라 <strong>분석</strong> —
            "이 게임은 이렇다"가 아니라 "왜 이렇게 만들었을까"까지 가야 역기획서입니다.
          </p>
        </div>
        ...
        <div className="rs-panel">
          ...
          <ul>
            ...
            <li>포맷 불안 — 실무 포맷은 회사마다 다릅니다. 중요한 것은 읽는 사람이 이해할 수 있는 구조이지, 특정 양식이 아닙니다. 템플릿은 출발점으로만 쓰세요.</li>
            <li>완성하지 못하는 것 — 지망생의 최대 적은 미완성입니다. 챌린지의 마감을 활용하세요.</li>
          </ul>
        </div>
