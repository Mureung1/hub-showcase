...
| 주차 | 목표 |
|---|---|
| 1주차 | 기획 확정, ERD/API 설계, 프로젝트 세팅 (Flutter/Spring Boot 초기화, CI 구성) |
| 2주차 | 핵심 도메인 구현 — 랜덤 챌린지 발급, 사진 기록 CRUD, 캘린더 조회 |
| 3주차 | 소규모 친구 방 (초대/참여, 완료 여부 공유), 푸시 알림 연동 |
| 4주차 | AI 데일리 케어 메시지 연동, QA/버그 수정, 배포 및 데모 준비 |
