...
| 외부 연동 | Java adapter·Gate/Gateway 자동 검증 완료, Local Live 미검증·cloud 미배포 | 교체 key canary와 승인된 배포 E2E |
...
- [서비스 완성 roadmap](docs/roadmap.md): PP-001~PP-037 Task DAG와 완료 기준
...
- Mock 자동 검증, 실제 Local Live와 클라우드 배포를 서로 다른 상태로 기록한다.
