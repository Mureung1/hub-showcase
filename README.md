...
| [docs/backlog.md](docs/backlog.md) | 구현 Task(T01~T19) 순서·선행조건·상태 |
| [docs/checklist.md](docs/checklist.md) | 검증 완료조건(C01~C19) — Task별 acceptance criteria |
...
│   ├── backlog.md            # 구현 Task T01~T19 (순서·선행조건·상태)
│   ├── checklist.md          # 검증 완료조건 C01~C19 (acceptance criteria)
