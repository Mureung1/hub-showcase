...
- [기획서](docs/기획서.md) — 페르소나·문제정의·MVP 범위
- [API 설계](docs/api-design.md) — 엔드포인트 계약, DB 스키마
- [백로그](docs/backlog.md) — 남은 작업/완료 작업 요약
- [2주차 계획수립](docs/2주차%20계획수립.md) — Day별 진행 계획

## 개발 계획 / 로드맵

현재 진행 중인 작업과 우선순위는 GitHub Issues에서 관리합니다.
