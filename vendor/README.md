...
| --- | --- | --- |
| [`ai-sdk-provider-codex-cli/`](ai-sdk-provider-codex-cli/UPSTREAM.md) | `v2.1.1` donor baseline 위 `FP-0001`–`FP-0007a`가 적용된 App Server-only exact-pin private fork | 없음. Root npm workspace, `packages/runtime-codex`, Server, Inspector와 분리됨 |
