...
| --- | --- | --- |
| [`ai-sdk-provider-codex-cli/`](ai-sdk-provider-codex-cli/UPSTREAM.md) | `v2.1.1` pristine donor baseline과 provenance metadata | 없음. Root npm workspace, Server, Inspector와 분리됨 |
