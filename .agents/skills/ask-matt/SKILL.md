...
- **`/camp-daily-pr`** — when the day's work has accumulated on `codex/MMDD`, interview the user section by section and create the camp template PR from `codex/MMDD` to `N180_하성욱`. It creates the PR but does not merge it.
