...
from localtwin_api.routers.industry_taxonomy import create_industry_taxonomy_router
...
def create_market_router(get_session_factory: Callable[[], sessionmaker[Session]]) -> APIRouter:
    ...
    router.include_router(create_industry_taxonomy_router(get_session_factory))
