...
const guides = {
  카페: [
    ...
    ["점포당 추정매출", "경쟁 점포 한 곳당 매출 수준", "점포 수가 많아도 수요가 충분한지 비교합니다."],
  ],
  음식점: [
    ["시간대별 유동인구", "점심·저녁 수요가 움직이는 시간", "주력 식사 시간과 영업시간을 맞출 때 봅니다."],
    ["점포당 추정매출", "음식점 한 곳당 매출 수준", "상권의 소비 규모가 경쟁을 감당하는지 확인합니다."],
  ...
  편의점: [
    ["상주·직장인구", "반복 구매를 만들 배후 고객", "주거형인지 직장형인지 상권 성격을 구분합니다."],
