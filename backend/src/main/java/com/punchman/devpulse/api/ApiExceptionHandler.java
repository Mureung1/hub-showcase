...
public class ApiExceptionHandler {
    ...
    @ExceptionHandler(CertificationRankingNotFoundException.class)
    public ResponseEntity<ErrorResponse> handleNotFound(CertificationRankingNotFoundException e) {
