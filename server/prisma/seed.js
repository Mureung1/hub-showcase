...
const exercises = [
  ...
  },
  {
    name: '푸시프레스',
    targetArea: '어깨',
    involvedJoints: ['어깨', '팔꿈치', '고관절', '무릎', '발목'],
  },
  ...
  // 하체
  {
    name: '스쿼트',
    targetArea: '하체',
    involvedJoints: ['무릎', '고관절', '발목'],
  },
  {
    name: '데드리프트',
    targetArea: '하체',
    involvedJoints: ['고관절', '무릎', '발목', '허리'],
  },
  {
    name: '루마니안 데드리프트',
    targetArea: '하체',
    involvedJoints: ['고관절', '허리'],
  },
  {
    name: '런지',
    targetArea: '하체',
    involvedJoints: ['고관절', '무릎', '발목'],
  },
  {
    name: '레그프레스',
    targetArea: '하체',
  ...
  // 복합
  {
    name: '파머스워크',
    targetArea: '복합',
    involvedJoints: ['허리', '고관절', '무릎', '발목', '어깨'],
  },
]
...
async function seedDemoRoutine() {
  ...
  const exerciseId = async (name) =>
    (await prisma.exercise.findFirstOrThrow({ where: { name } })).id
