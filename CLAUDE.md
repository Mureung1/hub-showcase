...
대학생의 전공·경험을 바탕으로 링커리어의 인턴/대외활동/공모전 공고를 추천하고, 선택한 공고에 맞는 자기소개서 초안을 작성해주는 Agent 서비스.

**문제 정의**: 대학생은 공모전·대외활동·인턴십 공고 중 자신에게 맞는 것을 고르기 어렵고, 자기소개서 문항에 맞춰 자기 경험을 정리해 쓰는 데도 어려움을 겪는다.
...
1. **정보 입력** — 전공/학점 필수, 부전공 선택, 자격증 복수 입력, 기타 경험(현장실습/인턴/교육) 자유 입력.
...
디자인 시스템은 확정됐고([docs/design-system.md](docs/design-system.md)), 아직 React 구현 전이다.
...
- `src/App.jsx` — 현재 유일한 화면(소개 랜딩). 새 화면을 만들 때 여기를 참고하되, 이 파일 자체는 곧 실제 "정보 입력" 화면으로 교체될 예정([docs/checklist.md](docs/checklist.md) T4).
