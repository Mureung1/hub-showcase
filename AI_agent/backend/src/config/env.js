...
export const env = {
  ...
  openaiFileFeedbackEnabled: process.env.OPENAI_FILE_FEEDBACK_ENABLED === "true",
  ...
  submissionFileMaxBytes: Number(process.env.SUBMISSION_FILE_MAX_BYTES || 5 * 1024 * 1024),
