...
- [ ] 방 생성 (최대 6명)
- [ ] 초대코드 참여
- [ ] `GET /rooms/{id}/completion/today` (O/X만)
...
| 마일스톤 | 포함 Task | 상태 |
|---|---|---|
| M0 — 문서·셋업 | Task 0 | 🔄 진행 중 |
| M1 — UI 프로토타입 | Task 1 | ⬜ 대기 |
| M2 — 인증 | Task 2 | ⬜ 대기 |
| M3 — 핵심 기록 | Task 3, 4 | ⬜ 대기 |
| M4 — 소셜(비교 없음) | Task 5 | ⬜ 대기 |
| M5 — AI·알림 | Task 6, 7 | ⬜ 대기 |
